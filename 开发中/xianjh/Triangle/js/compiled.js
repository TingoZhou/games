...
function start(h) {
    ...
    function lose() {
        ...
        _('results').style.margin = '30px';
        _('results').innerHTML = '失败!';
        _('results').innerHTML += '<br /><br /><button onClick="stopWin();start(lvl)">重新挑战</button>'
    };
    ...
    function tally() {
        ...
        if (g.playerTotal == j && checkWin()) {
            ...
            _('results').innerHTML += '<br /><br /><button onClick="stopWin();start(lvl+=1)">下一关</button>'
        } else {
            _('results').innerHTML = ''
        }
    }
